...
const tickets = [
  {
    ...
    workflow: {
      ...
      "Priority Assessment": "I selected P2 – Medium because one user was fully blocked, there was no immediate workaround and core access was affected. A wider outage would have raised the priority.",
      ...
      "Tools and Commands Used": "Active Directory Users and Computers and a supervised PowerShell account-status check. I also reviewed Windows Credential Manager.",
      "Findings": "The account unlocked successfully but locked again after the connected mail application retried its saved password.",
      "Root Cause": "A device retained the previous password and repeatedly submitted invalid authentication attempts.",
  ...
  },
  {
    ...
    workflow: {
      ...
      "Priority Assessment": "I selected P2 – Medium because a core service was affected for one user, but a reliable workaround was available.",
      "Initial Assessment": "My first assumption was a local Outlook connectivity, cache or profile problem rather than a Microsoft 365 account failure.",
      ...
      "Tools and Commands Used": "Outlook connection status, Outlook on the web, Windows Credential Manager and Microsoft 365 service information available in the scenario.",
      ...
      "Verification": "I sent and received a small test message in desktop Outlook and confirmed the folders synchronised.",
  ...
  },
  {
    ...
    workflow: {
      ...
      "Priority Assessment": "I selected P3 – Low because only one user was affected, an alternative printer was available and the printer remained available to others.",
      "Initial Assessment": "My first assumption was a local queue, spooler, port or status problem rather than failed printer hardware.",
      ...
      "Tools and Commands Used": "Windows printer queue, Print Management, Windows Services and ping to the known printer address.",
  ...
  },
  {
    ...
    workflow: {
      ...
      "Priority Assessment": "I selected P2 – High because one user was blocked from a time-sensitive business resource and no approved workaround was available. The scope did not justify P1.",
      "Initial Assessment": "My first assumption was that the VPN tunnel was active but DNS, routing, permissions or a stale mapping was failing.",
      ...
      "Tools and Commands Used": "VPN client status, ipconfig /all, nslookup, ping and net use.",
      "Findings": "The tunnel carried internal traffic, but the session retained public DNS information and could not resolve the internal file-server name.",
      "Root Cause": "The VPN session did not refresh the expected DNS configuration after connecting.",
      "Resolution": "I disconnected the VPN, refreshed the network configuration, reconnected and confirmed the approved internal DNS settings were applied before restoring the mapping.",
      "Verification": "I resolved the server name, opened the shared drive and tested read access to an authorised file.",
  ...
  },
  {
    ...
    environment: "Windows 11, Active Directory, Entra ID, Microsoft 365, Intune concepts",
    status: "Completed",
    time: "Illustrative resolution target: before start date",
    workflow: {
      ...
      "Priority Assessment": "I selected P4 – Planned Request because the work was scheduled in advance and no current user was experiencing an outage. The start date created the completion target.",
      "Initial Assessment": "My first assumption was that success depended on complete and approved role information, not only account creation.",
      ...
      "Tools and Commands Used": "Active Directory Users and Computers, Entra ID and Microsoft 365 administration concepts, Windows 11 setup and Intune learning concepts where appropriate.",
      ...
      "Root Cause": "This was not a fault incident; the main risk was an incomplete request causing a missed onboarding dependency.",
      "Resolution": "I completed the approved account, licence, groups, device, MFA preparation and resource checklist, then added the mailbox after approval.",
    ...
    <article class="ticket-card reveal">
      <div class="ticket-summary">
        ...
        <dl class="ticket-metadata">
          ...
          <div><dt>Resolution time</dt><dd>${escapeHtml(ticket.time)}</dd></div>
        </dl>
